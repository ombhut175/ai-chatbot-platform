...
import { Loader2, AlertCircle, Shield, Lock, Users, Bot } from "lucide-react"
...
function UnifiedChatContent() {
      ...
      <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800">
        ...
        >
          <div className="relative mb-6">
            ...
            <div className="relative p-4 bg-primary/10 rounded-full inline-flex">
              <Bot className="w-8 h-8 text-primary animate-pulse" />
            </div>
          </div>
          <div className="space-y-2">
            <Loader2 className="w-6 h-6 animate-spin mx-auto mb-2" />
            <p className="text-muted-foreground font-medium">Loading chatbot...</p>
            <p className="text-sm text-muted-foreground/70">Verifying access permissions</p>
          </div>
        </motion.div>
      </div>
    )
  ...
  // Successfully loaded chatbot
  if (chatbot) {
    // For internal chatbots, show enhanced UI with user information
    ...
    // For public chatbots, use the regular interface
